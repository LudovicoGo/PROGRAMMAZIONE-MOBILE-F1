...
class SprintResultsAdapter(
    private val context: Context,
    private val data: List<SprintResult>
) : RecyclerView.Adapter<SprintResultsAdapter.SprintResultsViewHolder>() {

    inner class SprintResultsViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SprintResultsViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.race_results_listview, parent, false)
        return SprintResultsViewHolder(itemView)
    }

    override fun onBindViewHolder(holder: SprintResultsViewHolder, position: Int) {
